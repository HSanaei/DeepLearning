# -*- coding: utf-8 -*-
"""12-1E. HosseinSanaei-DeepLearning-Chapter12-Exercise-1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1eVHeGc8uaOS_CdZkU3MIlH7Odg-ss3e1
"""

'''
Python Machine Learning
Teacher: Dr Rahmani
Student: Hossein SANAEI ~حسين سنايی
...
def generate_plot_pics(datagen, original_img, save_prefix):
    ...
    for file in os.listdir(folder):
        if file.startswith(save_prefix):
           ...
           aug_img = image.load_img(folder + "/" + file)
           plt.imshow(aug_img)
